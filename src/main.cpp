...
int main(int argc, char **argv)
{
    ...
    cmake_parser.add_argument("--cstd", "-c").help("C standard").scan<'i', int>().default_value<int>(99);
    cmake_parser.add_argument("--cxxstd", "-C").help("C++ standard").scan<'i', int>().default_value<int>(20);
    cmake_parser.add_argument("--project", "-p").help("Project and executable name").default_value<std::string>("foo");
    cmake_parser.add_argument("--main-lang", "-m").help("Main language of the project").default_value("CXX");
